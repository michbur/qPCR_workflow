...
from the negative control (Figure~\ref{figure:dpcR_bioamp}~G04). 
Statistical capabilities of R simplifies next steps of the analysis of digital 
PCR experiments. The \CRANpkg{dpcR} package offers a flexible wrapper 
...
\begin{figure}[htbp]
  \centering
  \includegraphics[scale=0.5]{figures/test_counts.pdf}
