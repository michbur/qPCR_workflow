...
traditional qPCR measures dPCR absolute nucleic acids amounts. This is possible 
after 'clonal DNA amplification' in thousands of small separated partitions 
(e.g., droplets, nano chambers) \citep{huggett_2013, milbury_2014, morley_2014}. 
...
Recently, we have published the \CRANpkg{dpcR} package at CRAN, which is the 
first open source R software package for the analysis of dPCR experiments (see 
\CRANpkg{dpcR} package manual for details).
...
\CRANpkg{rateratio.test} as proposed by \citet{Fay_2010}.
