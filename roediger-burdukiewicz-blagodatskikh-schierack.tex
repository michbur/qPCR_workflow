...
\citep{pabinger_2014}. Only few bioanalytical appliances had such a 
...
\pkg{RStudio} \citep{RStudio, gandrud_2013} or other technologies 
...
(v.~0.8-2) to our workspace. The \CRANpkg{chipPCR} package 
...
\begin{figure}[htbp]
  \centering
  \includegraphics[clip=true, width=14cm]{figures/RDML_dendrogram.pdf}
...
between different dPCR platforms. 
...
data set, which originates from a BioRad QX100 Droplet Digital PCR System 
...
Our experimental setup was as followed. Gating and droplet clustering was taken 
without any modification from the data output of the BioRad QX100 Droplet  
Digital PCR System. Further details are described in the manual of the 
\CRANpkg{dpcR} package. Briefly, 

Each droplet is represent by a dot in Figure~\ref{figure:dpcR_bioamp}.
...
dashed line ({\textbf{\textendash\textendash}}). $Cluster~1$~\textcolor{black}{\textbf{\textbullet}}, 
$Cluster~2$~\textcolor{red}{\textbf{\textbullet}}, 
$Cluster~3$~\textcolor{green}{\textbf{\textbullet}}, 
$Cluster~4$~\textcolor{blue}{\textbf{\textbullet}}; Column two: Density function 
with showing the number of molecules per partition; Column three: Concentration 
of DNA molecules based on the volume used by the BioRad QX100 Droplet Digital 
PCR System and the volume proposed by \citet{corbisier_2015}. 
