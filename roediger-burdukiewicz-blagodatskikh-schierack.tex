...
generation and analysis of data, multiple hypothesis testing, interpretation, reporting and storage of 
results \citep{huggett_BDQ_2014, conde_2014}. The scientific misconduct and fraud have shaken 
the scientific community on several occasions \citep{fang_2012}. In particular, 
the scientific community works hard to uncover pitfalls of qPCR experiments. This 
...
analysis is often performed in spreadsheets. However, this data processing approach is not 
...
In the following sections we will show how R can be used (I) as an unified open 
...
curve data. \strong{(A)} The raw amplification curve data were pre-processed with 
...
temperature and to monitor the amplification reaction. The VideoScan technology is based 
...
1.25 $\mu$L 10xb~uffer, 0.75 $\mu$L primer (150 nM final), 0.5 $\mu$L template 
...
611X. We would like to thank the R community. Part of this work was funded by the 
