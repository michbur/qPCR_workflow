...
detection of overall \textit{M.tuberculosis} DNA (wild-type and mutant) by 
intercalating dye EvaGreen® within qPCR and specific detection of wild-type 
...
95~\textcelsius, followed by 41 cycles (95~\textcelsius for 15 s; 
65~\textcelsius for 40 s) with a single fluorescent reading taken at the end of 
each cycle. Probe melting was conducted by decreasing temperature from 
95~\textcelsius to 35~\textcelsius by 1~\textcelsius at 1 s steps.
\begin{example}
# Load the required packages for the data import and analysis.
