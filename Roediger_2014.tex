...
with the MIQE guidelines to increase experimental transparency for better 
...
acceptable publication quality. Aside from closed source software, analysis of PCR 
reactions is generally performed in spreadsheets. This approach of data processing 
is not advisable for research purposes. Spreadsheets often lack (or do not use) 
tools to validate input, debug implemented procedures and automatize worflow. These traits make them prone to errors and not well suited for complicated 
