...
detection and analysis. \strong{(B)} Subsequently the samples can be 
digitalized 
...
\citep{roediger_RJ_2013}) using the \code{CPP} function from the 
...
In detail, we mimicked an in-silico experiment for a droplet digital PCR. The 
