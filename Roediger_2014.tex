...
\CRANpkg{dpcR}. In detail, we performed an in-silico experiment, which mimicked 
a droplet digital PCR (e.g., Bio-Rad QX100 systems). The aim was to do a density 
estimation. The average droplet value was assumed to be 5 nL. 
