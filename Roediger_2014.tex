...
This study gave a brief introduction in the analysis of qPCR, qIA, MCA and dPCR 
experiments with R. In addition, we briefly referenced to a vast collection of 
additional packages available from CRAN and Bioconductor. The packages may be 
considered building blocks (libraries) to create what users want and need. We 
...
workflow and to set up environment for specific needs in a broad range of 
...
for high-throughput analysis. R allows accessing and reuse code for the creation 
