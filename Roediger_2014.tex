...
packages available. Here we describe exemplary work-flows for the analysis of 
...
regression analysis we setted the parameter $CI = TRUE$. Finally, Cq values were plotted 
...
As shown in this case study, it is easy to set-up a streamlined work-flow for data 
...
In this study we used the \code{th.cyc} function to determine the time 
...
provides a flexible work-flow for individuals. \strong{(B)} Another approach is 
